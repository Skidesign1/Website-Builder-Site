const HeroSection = () => {
    return (
        <div>
            <section className="min-w-[50vw] bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-20 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between">
                {/* Text Content */}
                <div className="md:w-1/2 text-center md:text-left">
                    <h1 data-editable='twxt' className="text-4xl md:text-6xl font-bold leading-tight">
