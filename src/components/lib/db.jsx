...
const final = [
    ...
    { type: 'shop', id: 'shop', text: 'shop-001', category: 'shop', icon: <ChartBarIcon className="w-4 h-4" />, component: <ShoppingCart />, label: 'shoppingcart' },
    ...
    { type: 'image', id: 'comment', text: 'comment-001', category: 'comment', icon: <DocumentTextIcon className="w-4 h-4" />, component: <CommentSection />, label: 'commentsection' },
